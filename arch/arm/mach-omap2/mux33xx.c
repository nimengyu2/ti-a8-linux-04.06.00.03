...
static struct omap_mux __initdata am33xx_muxmodes[] = {
	...
	_AM33XX_MUXENTRY(SPI0_SCLK, 0,
		NULL, "uart2_rxd", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM33XX_MUXENTRY(SPI0_D0, 0,
		NULL, "uart2_txd", NULL, NULL,
		NULL, NULL, NULL, NULL),
	_AM33XX_MUXENTRY(MII1_TXD3, 0,
		NULL, NULL, NULL, "uart4_rxd",
		NULL, NULL, NULL, NULL),
	_AM33XX_MUXENTRY(MII1_TXD2, 0,
		NULL, NULL, NULL, "uart4_txd",
		NULL, NULL, NULL, NULL),
	_AM33XX_MUXENTRY(MII1_COL,0,
		NULL, NULL, NULL, "uart5_rxd",
		NULL, NULL, NULL, NULL),
	_AM33XX_MUXENTRY(MII1_RXDV, 0,
		NULL, NULL, NULL, "uart5_txd",
		NULL, NULL, NULL, NULL),
	*/
	...
	_AM33XX_MUXENTRY(UART0_CTSN, 0,
		"uart0_ctsn", "uart4_rxd", "d_can1_tx", NULL,
		"spi1_d0", NULL, NULL, NULL),
	_AM33XX_MUXENTRY(UART0_RTSN, 0,
		"uart0_rtsn", "uart4_txd", "d_can1_rx", NULL,
