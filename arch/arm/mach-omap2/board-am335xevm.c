...
{	
	pr_info("lierda:enter lcdc_init\n");
...
{
	pr_info("lierda enter rmii1_init function\n");		
...
static void evm_nand_init(int evm_id, int profile)
{
	...
	pr_info("lierda:enter in evm_nand_init function.\n");
}
...
static void mcasp0_init(int evm_id, int profile)
{
	...
	pr_info("lierda:enter in mcasp0_init function.\n");
	return;
}
...
static void mcasp1_init(int evm_id, int profile)
{
	...
	pr_info("lierda:enter in mcasp1_init function.\n");
	return;
}
...
static void mmc1_init(int evm_id, int profile)
{
	...
	pr_info("lierda:enter in mmc1_init function.\n");
...
{
	pr_info("lierda:enter in uart1_wl12xx_init function.\n");	
...
static void mmc0_no_cd_init(int evm_id, int profile)
{
	...
	omap2_hsmmc_init(am335x_mmc);
	pr_err("lierda:enter mmc0_no_cd_init\n");
	return;
}
...
static void am335x_evm_setup(struct memory_accessor *mem_acc, void *context)
{
	int ret;
	char tmp[10];
	pr_warning("lierda: after AM335X: EVM Config read fail: \n");
...
{
	pr_info("lierda enter am335x_evm_init function\n");	
	am33xx_cpuidle_init();
